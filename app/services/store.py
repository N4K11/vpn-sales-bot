...
DEFAULT_CONTENT: dict[str, tuple[str, str]] = {
    'main': ('Экран «Главное меню»', 'Добро пожаловать в VPN-бота.\n\nВыберите нужный раздел ниже.'),
    'profile': ('Экран «Мой профиль»', 'Здесь собраны ваши активные подписки, ключи доступа, общая ссылка и баланс.'),
    'buy': ('Экран «Купить VPN»', 'Выберите тариф, а затем удобный способ оплаты.'),
    ...
    'button_nav_buy': ('Кнопка «Купить VPN» — главный экран и быстрые переходы', '🛒 Купить VPN'),
    ...
    'button_subscription_copy': ('Кнопка «Скопировать ссылку» — карточка подписки', '📋 Скопировать ссылку'),
    ...
    'button_reserve_copy': ('Кнопка «Скопировать резервную ссылку» — подписка и результат выдачи', '📋 Скопировать резервную ссылку'),
