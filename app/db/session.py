...
async def init_db() -> None:
    async with engine.begin() as conn:
        ...
        if conn.dialect.name == "sqlite":
            ...
            if "reminder_sent_at" not in payment_columns:
                await conn.exec_driver_sql("ALTER TABLE payments ADD COLUMN reminder_sent_at DATETIME")
            ...
            await conn.exec_driver_sql("ALTER TABLE payments ADD COLUMN IF NOT EXISTS reminder_sent_at TIMESTAMPTZ")
